...
const Hero = () => {
  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bh-hero bg-cover bg-center">
        <img src={bigShoeImg} alt="shoe Collection" width={610} height={500} className="object-contain relative z-10" />
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
          {shoes.map((shoeItem) => (
            <div key={shoeItem.thumbnail}>
              <ShoeCard imgURL={shoeItem} changeBigShoeImage={(shoe) => setBigShoeImg (shoe)} />
